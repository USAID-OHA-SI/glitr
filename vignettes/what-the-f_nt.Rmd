...
-   To install on your GFE, open Software Center App, click on "Source Sans Pro (Google Web Font)", and then select install.
...
-   Navigate to Tools \> Global Options \> General \> Graphics \> Graphic Device.
-   Change the Grapahic Device Backend to "AGG" (it will likely be "(Default)").
